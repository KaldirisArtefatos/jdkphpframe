<?php        
    include __DIR__ . '/db_base.php';
    error_reporting(0);    
?>

<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <img class="mb-4 logo" src="<?php global $config; echo $config["URL_PORTAL"] ."/" ?>imagens/logo.png" alt="" width="80">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        ...
        <?php 
                    ...
                    if(empty($_SESSION["nomeCliente"])){
                        echo "<a class='lnk-entrar' href='". $config['URL_PORTAL'] ."/login.php'>Entrar</a>";                         
                    }
                    else{
                        global $config;
        ...
        <div class="user-profile">
            ...
            <img  src="<?php global $config; echo $config["URL_PORTAL"] ."/" ?>imagens/user.png">
        </div>
    </div>
</nav>